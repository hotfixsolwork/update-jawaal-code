...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        // Product sellers
        Route::get('/products/sellers/{id}', 'productSellers')->name('products.sellers.show');
    ...
    Route::controller(ReportController::class)->group(function () {
        ...
        Route::post('/wallet-request/approve', 'waletApprove')->name('wallet.request.approve');
        Route::post('/wallet-request/reject', 'waletReject')->name('wallet.request.reject');
    });
