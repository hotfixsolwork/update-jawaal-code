...
//     return \App\Models\User::whereDoesntHave('shop')->whereIn('user_type', ['customer', 'seller'])->pluck('id'); 
// });
...
Route::prefix('supplier')->group(function(){
    ...
    // step 1
    Route::get('registration', [RegisterController::class, 'registration'])->name('supplier.registration');
    Route::post('register', [RegisterController::class, 'register'])->name('supplier.register');
    
    // step2
    Route::get('otp-verification', [RegisterController::class, 'otpVerificationForm'])->name('supplier.otp-verification');
    Route::post('otp-verify', [RegisterController::class, 'verifyOTP'])->name('supplier.otp.verify');
    Route::post('otp-resend', [RegisterController::class, 'resendOTP'])->name('supplier.otp.resend');
    Route::get('required-documents', [RegisterController::class, 'requiredDocuments'])->name('supplier.required-documents');
    
    // step 3
    Route::get('business-information', [RegisterController::class, 'businessInformation'])->name('supplier.business-information.form');
    Route::post('business-information-submit', [RegisterController::class, 'submitBusinessInformation'])->name('supplier.business-information.submit');
    
    // step 4
    Route::get('legal-information', [RegisterController::class, 'legalInformation'])->name('supplier.legal-information.form');
    Route::post('legal-information-submit', [RegisterController::class, 'submitlegalInformation'])->name('supplier.legal-information.submit');
    
    // step 5
    Route::get('bank-information', [RegisterController::class, 'bankInformtion'])->name('supplier.bank-information.form');
    Route::post('bank-information-submit', [RegisterController::class, 'submitBankInformtion'])->name('supplier.bank-information.submit');
    
    // regitsration status page
    Route::get('/{user_id}/registration-status', [RegisterController::class, 'registrationStatus'])->name('registration.status')->middleware('signed');
});
...
Route::prefix('seller')->group(function(){
    ...
    // step 1
    Route::get('registration', [SellerRegisterController::class, 'registration'])->name('seller.registration');
    Route::post('register', [SellerRegisterController::class, 'register'])->name('seller.register');
    
    // step2
    Route::get('otp-verification', [SellerRegisterController::class, 'otpVerificationForm'])->name('seller.otp-verification');
    Route::post('otp-verify', [SellerRegisterController::class, 'verifyOTP'])->name('seller.otp.verify');
    Route::post('otp-resend', [SellerRegisterController::class, 'resendOTP'])->name('seller.otp.resend');
    Route::get('required-documents', [SellerRegisterController::class, 'requiredDocuments'])->name('seller.required-documents');
    
    // step 3
    Route::get('business-information', [SellerRegisterController::class, 'businessInformation'])->name('seller.business-information.form');
    Route::post('business-information-submit', [SellerRegisterController::class, 'submitBusinessInformation'])->name('seller.business-information.submit');
    
    // step 4
    Route::get('legal-information', [SellerRegisterController::class, 'legalInformation'])->name('seller.legal-information.form');
    Route::post('legal-information-submit', [SellerRegisterController::class, 'submitlegalInformation'])->name('seller.legal-information.submit');
    
    // step 5
    Route::get('bank-information', [SellerRegisterController::class, 'bankInformtion'])->name('seller.bank-information.form');
    Route::post('bank-information-submit', [SellerRegisterController::class, 'submitBankInformtion'])->name('seller.bank-information.submit');
    
    // regitsration status page
    Route::get('/{user_id}/registration-status', [SellerRegisterController::class, 'registrationStatus'])->name('seller.registration.status')->middleware('signed');
});
