...
<body>
	<div>
		...
		@if(isset($supplier))
		    @if($supplier->user_type != 'admin')
		        <div style="padding: 1rem">
		    <h4>Supplier Info</h4>
            <table>
				<tr>
				    <td class="strong small gry-color">Supplier Name</td>
				    <td class="strong">{{@$supplier->name}}</td>
				</tr>
				<tr>
				    <td class="strong small gry-color">Email</td>
				    <td class="strong">{{@$supplier->email}}</td>
				</tr>
				<tr>
				    <td class="strong small gry-color">Shop Name</td>
				    <td class="strong">{{@$supplier->shop->name}}</td>
				</tr>
			</table>
		</div>
		    @endif
