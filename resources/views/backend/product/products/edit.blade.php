            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body mt-4">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 col-from-label">{{translate('Available Rams')}}</label>

                            <div class="col-md-8">

                                <input type="text" class="form-control aiz-tag-input" name="rams[]" value="{{ $product->rams }}" placeholder="{{ translate('Type and hit enter to add a ram') }}">
                         ...
                         <div class="form-group row">
                            ...
                            <label class="col-md-3 col-from-label">{{translate('Available Storage')}}</label>

                            <div class="col-md-8">

                                <input type="text" class="form-control aiz-tag-input" name="storage[]"  value="{{ $product->storage }}" placeholder="{{ translate('Type and hit enter to add a storage') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h5 class="mb-0 h6">{{translate('Product Specifications')}}</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-lg-3 col-from-label">{{translate('Specifications')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>

                            <div class="col-lg-9">

                                <textarea class="aiz-text-editor" name="specifications">{{ $product->specifications }}</textarea>
