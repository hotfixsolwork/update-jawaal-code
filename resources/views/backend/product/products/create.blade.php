                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control aiz-tag-input" name="rams[]" placeholder="{{ translate('Type and hit enter to add a ram') }}">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control aiz-tag-input" name="storage[]" placeholder="{{ translate('Type and hit enter to add a storage') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 col-from-label">{{translate('Specifications')}}</label>

                            <div class="col-md-8">

                                <textarea class="aiz-text-editor" name="specifications"></textarea>
