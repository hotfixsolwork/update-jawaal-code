        ...
        <section class="container  mb-3 mt-5">
            <div class="row gutters-16">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    <div class="w-100">
                        <h1 class="fs-60 fw-700" style="line-height: 70px; font-size: 4rem;">  {{ translate('The smartest way to growing trade wholesale')}}</h1>
                        <h5 style="line-height: 35px; font-size: 1.6rem;"> {{ translate('jawwal is a B2B marketplace that connects small businesses with wholesalers and brands in one place to enabling a seamless, insightful and bold way of doing businesses')}}</h5>
                    </div>
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    <div class="w-100">
                        <img class="d-block lazyload h-100 img-fit" 
                            src="{{ static_asset('assets/img/home.svg') }}" style="width: 80%">
                    </div>
                </div>
