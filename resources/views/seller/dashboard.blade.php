...
@section('panel_content')
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-xxl-4">
            <div class="card mb-4 bg-grad-1 text-dark-blue py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small mb-0">
                            ...
                            <h3 class="mb-0 fs-30">
                                {{ DB::table('seller_products')->where('seller_id', Auth::user()->id)->count() }}
                            </h3>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14">{{ translate('Total Order') }}</span>
                            </p>
                            <h3 class="mb-0 fs-30">
