            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Catalogues') }}</span>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.products.create')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.products.create']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Jawwal Catalogue') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.products') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.products', '', 'seller.products.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('My Catalogue') }}</span>
                            </a>
                        </li>
                ...
                @if (get_setting('coupon_system') == 1)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('seller.coupon.index') }}"
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Poromtion') }}</span>
                        </a>
                    </li>
                @endif
