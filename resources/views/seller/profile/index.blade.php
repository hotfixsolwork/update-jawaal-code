...
@section('panel_content')
    ...
    <form action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
       ...
       <!-- Shop Info-->
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{ translate('Shop Info')}}</h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="name">{{ translate('Shop Name (En)') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="shop_name" value="{{$user->shop->name}}" id="shop_name" class="form-control" placeholder="{{ translate('Shop Name English') }}" required>
                        @error('shop_name')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="name">{{ translate('Shop Name (Ar)') }}</label>
                    <div class="col-md-10">
                        <input type="text" name="shop_name_ar" value="{{$user->shop->name_ar}}" id="shop_name_ar" class="form-control" placeholder="{{ translate('Shop Name Arabic') }}" required>
                        @error('shop_name_ar')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="name">{{ translate('Business Details') }}</label>
                    <div class="col-md-10">
                        <textarea name="business_details" id="business_details" class="form-control" required>{{ $user->shop->business_details }}</textarea>
