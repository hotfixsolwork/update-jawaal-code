                ...
                <div class="modal-body c-scrollbar-light">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('Building No')}}" rows="2" name="building_no" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3 rounded-0" placeholder="{{ translate('Street Name')}}" rows="2" name="street_name" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Your Zip Code')}}" name="postal_code" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Additional No')}}" name="additional_no" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Unit No')}}" name="unit_no" value="" required>
                            </div>
                        </div>
