@php
    $best_selling_products = Cache::remember('admin_best_selling_products', 86400, function () {
        return  filter_products(\App\Models\Product::where('published', 1)->where('added_by', 'admin')->orderBy('num_of_sale', 'desc'))->limit(20)->get();
    });   
@endphp
