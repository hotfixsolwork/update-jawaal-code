...
@section('meta')
    ...
    <style>
        ...
        .box-shadow{
            box-shadow: rgba(41, 186, 215, 1) 0px -12px 0px, rgba(41, 186, 215, 1) 0px 0px 5px;
            border-radius:10px
        }
        .box-shadow-two{  
           box-shadow: rgba(41, 186, 215, 1) -1px 0px 3px, rgba(41, 186, 215, 1) 1px 2px 1px;
           border-radius:10px
        }
            ...
            <div class="bg-white py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-xl-12 col-lg-12 mb-4 box-shadow">
                        ...
                        <div class="col-lg-12 mb-4 box-shadow-two pb-5">
                    ...
                    <div class="col-lg-6">
                        ...
                        @if (empty(request()->query('seller')))
                            ...
                            <h5 class="mb-"><b>{{ translate('Best Supplers') }}</b></h5>
                            ...
                            @foreach ($sellers as $seller)
                                ...
                                <?php
                                    ...
                                    $seller_price = \DB::table('seller_products')->where('seller_id', $seller->id)->where('product_id', $detailedProduct->id)->value('price');

                                        

                                ?>

                                <div style="background-color:rgba(248,248,248,255)" class="border p-2 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    if ($seller->shop->logo) {
                                        ...
                                        $logo = \App\Models\Upload::where('id', $seller->shop->logo)->value('file_name');

                                    }

                                    ?>

                                    <img src="{{ asset('public/' . $logo) }}" style="object-fit:cover;" width="50" height="50" class="img" />
                                    ...
                                    <div class="col-md-10 col-10 mt-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <p><b>{{ translate('Seller Name') }}:</b> {{ $seller->name }}</p>
                                            ...
                                            <div class="col-md-6 col-6">
                                                ...
                                                <a  href="{{ route('product', ['slug' => $detailedProduct->slug, 'seller' => $seller->id]) }}" 

                                                    class="btn btn-primary fw-400 rounded-0 text-white">

                                                    <span class="d-md-inline-block"> {{ translate('View Product') }}</span>
                                    ...
                                    <p><b>{{ translate('Contact') }}:</b> {{ $seller->phone ?? 'N/A' }}</p>

                                    <p><b>{{ translate('Price') }}:</b> {{ $seller_price }} SAR</p>
                        ...
                        <div style="background-color:#fff" class="border p-3 mb-2">
                            ...
                            <div class="row">
                                ...
                                $seller_id = request()->query('seller');
                                ...
                                <img src="{{ asset('public/' . $logo) }}" width="40" height="50" style="object-fit:cover;border-radius: 50%" />
