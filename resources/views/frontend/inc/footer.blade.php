                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    @if (get_setting('vendor_system_activation') == 1)
                        ...
                        <ul class="list-unstyled">
                            ...
                            @guest
                                <li class="mb-2">
                                    <a class="fs-13 text-soft-light animate-underline-white" href="{{ route('user.login', ['type' => 'seller']) }}">
                                        {{ translate('Login to Seller Panel') }}
                                    </a>
                                </li>
                                <li class="mb-2">
                                    <a class="fs-13 text-soft-light animate-underline-white" href="{{ route('user.login', ['type' => 'supplier']) }}">
                                        {{ translate('Login to Supplier Panel') }}
                                    </a>
                                </li>
                            @endguest
