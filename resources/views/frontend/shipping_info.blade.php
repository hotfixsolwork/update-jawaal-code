                            ...
                            <div class="border bg-white p-4 mb-4">
                                            ...
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                ...
                                                <span class="d-flex p-3 aiz-megabox-elem border-0">
                                                    ...
                                                    <span class="flex-grow-1 pl-3 text-left">
                                                        <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('Building No') }}</span>
                                                            <span class="fs-14 text-dark fw-500 ml-2 col">{{ $address->building_no }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('Street Name') }}</span>
                                                            <span class="fs-14 text-dark fw-500 ml-2 col">{{ $address->street_name }}</span>
                                                        </div>
                                                        
                                                        <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('District Name') }}</span>
                                                        ...
                                                        <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('Zip Code') }}</span>
                                                            <span class="fs-14 text-dark fw-500 ml-2 col">{{ $address->postal_code }}</span>
                                                        </div>
                                                        
                                                        <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('Additional No') }}</span>
                                                            <span class="fs-14 text-dark fw-500 ml-2 col">{{ $address->additional_no }}</span>
                                                        </div>
                                                        
                                                        <div class="row">
                                                            <span class="fs-14 text-secondary col-3">{{ translate('Unit No') }}</span>
                                                            <span class="fs-14 text-dark fw-500 ml-2 col">{{ $address->unit_no }}</span>
                                                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 text-center text-md-right">
                                        <button type="submit" class="btn btn-primary fs-14 fw-700 rounded-0 px-4">{{ translate('Continue to Payment')}}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
