...
@section('content')
                            ...
                            @foreach ($slider_images as $key => $value)
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <!-- Image -->
                                        <img class="d-block mw-100 img-fit overflow-hidden h-sm-auto h-md-320px h-lg-320px overflow-hidden"
                        ...
                        @foreach ($featured_categories as $key => $category)
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="bg-white pt-3 pl-3 pr-3 h-100 hov-scale-img" style="min-height: 240px !important;">
                                    <div class="row">
                                        <!-- Category Banner -->
                                        <div class="col-md-12 py-3 h-200px text-center h-md-100">
    ...
    @if (get_setting('top_brands') != null)
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    <!-- Title -->
                    <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">{{ translate('Brands Categories') }}</h3>
                    <!-- Links -->
                    <div class="d-flex">
    ...
    <div class="mb-2 mb-md-3 mt-2 mt-md-3" style="background-color: {{ get_setting('cupon_background_color', '#29bad7') }}">
        <div class="container">
            <div class="row py-5">
