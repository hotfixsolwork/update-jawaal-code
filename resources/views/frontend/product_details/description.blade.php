<div class="bg-white mb-4 border p-3 p-sm-4">
    ...
    <div class="nav aiz-nav-tabs">
        ...
        <a href="#tab_default_4" data-toggle="tab"
            class="mr-5 pb-2 fs-16 fw-700 text-reset show">{{ translate('Specifications') }}</a>
    ...
    <div class="tab-content pt-0">
        ...
        {{-- Specifications --}}
        <div class="tab-pane fade show" id="tab_default_4">
            <div class="py-5">
                <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                    <?php echo $detailedProduct->getTranslation('specifications'); ?>
                </div>
            </div>
        </div>
    </div>
