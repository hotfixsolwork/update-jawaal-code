...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($carts as $cartItem) {
            ...
            if (isset($seller_products[$cartItem['owner_id']])) {
                $product_ids = $seller_products[$cartItem['owner_id']];
            }
            array_push($product_ids, $cartItem);
            $seller_products[$cartItem['owner_id']] = $product_ids;
        }
        ...
        foreach ($seller_products as $seller_product) {
            ...
            foreach ($seller_product as $cartItem) {
                ...
                $order_detail->ram = $cartItem['ram'];
                $order_detail->storage = $cartItem['storage'];
                ...
                $order->seller_id = $cartItem['owner_id'];
