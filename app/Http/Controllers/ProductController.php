...
class ProductController extends Controller
{
    ...
    public function seller_products(Request $request)
    {
        ...
        $seller_products_ids = DB::table('seller_products')->pluck('product_id')->toArray(); 
        $products = Product::where('added_by', 'admin')->whereIn('id', $seller_products_ids)->where('auction_product', 0)->where('wholesale_product', 0);
    ...
    {
        $seller_ids = DB::table('seller_products')->where('product_id', $productId)->pluck('seller_id')->toArray();
        $sellers = \App\Models\User::whereIn('id', $seller_ids)->paginate(20);
        return view('backend.product.products.sellers', compact('sellers'));
    }
}
